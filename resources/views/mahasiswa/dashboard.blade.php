                                ...
                                <div>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h6 class="mb-0 font-size-15">Daftar Dosen Pembimbing</h6>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h6 class="mb-0 font-size-15">Daftar Perlombaan</h6>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar">
                                            <div class="avatar-title rounded bg-soft-primary">
                                                <i class="bx bx-history font-size-24 mb-0 text-primary"></i>
                                            </div>
                                        </div>

                                        <div class="flex-grow-1 ms-3">
                                            <h6 class="mb-0 font-size-15">History</h6>
                                        </div>
                                    </div>

                                    <div>
                                        <h4 class="mt-4 pt-1 mb-0 font-size-22">{{ $history_jumlah ?? '0' }} History<span
                                                class="text-success fw-medium font-size-13 align-middle"> </h4>
                                        <div class="d-flex mt-1 align-items-end overflow-hidden">
                                            <div class="flex-grow-1">
                                                <p class="text-muted mb-0 text-truncate">{{ date('Y-m-d H:i:s') }}
                            ...
                            <div class="card-body">
                                <div>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h6 class="mb-0 font-size-15">Jadwal Bimbingan</h6>
                                        </div>
                                    </div>

                                    <div>
                                        <h4 class="mt-4 pt-1 mb-0 font-size-22">{{ $bimbingan_jumlah ?? '0' }} Jadwal<span
                                                class="text-success fw-medium font-size-13 align-middle"> </h4>
                                        <div class="d-flex mt-1 align-items-end overflow-hidden">
                                            <div class="flex-grow-1">
                                                <p class="text-muted mb-0 text-truncate">{{ date('Y-m-d H:i:s') }}
