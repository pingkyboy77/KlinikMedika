    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Daftar Pengajuan Lomba</h5>
            </div>
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="table-history-lomba" class="table table-nowrap align-middle mb-0" >
                        ...
                        <tr>
                            ...
                            <td class="ps-2">
                                <a href="{{ route('mahasiswa.pengajuan-bimbingan' , ['id' => $item->id ]) }}">
                                    <button type="button"
...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Daftar Pengajuan Bimbingan</h5>
            </div>
            <div class="card-body">
...
{{-- <script>
    $(document).ready(function () {
        $('#myTable2').DataTable({
            "columnDefs": [
                { "orderable": false, "targets": [8] } // Menonaktifkan sorting pada kolom 8
            ],
            "language": {
                "emptyTable": "Tidak ada data yang tersedia dalam tabel"
            },
            "initComplete": function(settings, json) {
                if ($('#myTable2').DataTable().rows().count() == 0) {
