                        ...
                        <table class="table table-nowrap align-middle mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <td>
                                        <p class="mb-0">lokasi Bimbingan</p>
                                    </td>
                                    <td>
                                        <p class="mb-0">Tanggal Bimbingan</p>
                                    </td>
                                    <td>
                                        <p class="mb-0">Waktu Bimbingan</p>
                                    </td>
                                    <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-start g-3">
                                                <a class="btn btn-warning me-2"
                                                    href="{{ route('admin.update.daftarPengajuanBimbingan', ['id' => $item->id]) }}"><i
                                                        class="bx bx-pencil"></i>Edit</a>
                                                <form
                                                    action="{{ route('admin.DaftarPengajuanBimbingan.delete', ['id' => $item->id]) }}"
                                                    method="POST">
                                                    @method('delete')
                                                    @csrf
