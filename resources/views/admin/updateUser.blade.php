                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="password" name="password" class="form-control" placeholder="Enter Password"
                            id="CreateTask-Team-Member" value="{{ isset($user) ? '' : old('password') }}">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <select class="form-select" name="role" id="role_update">
                        ...
                        <option value="mahasiswa" @if (isset($user) && $user->role == 'mahasiswa') selected @endif>Mahasiswa</option>
                        <option value="dosen" @if (isset($user) && $user->role == 'dosen') selected @endif>Dosen</option>
                    </select>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <select class="form-select" name="kategori" id="kategori_update">
                        <option selected value="{{ $user->kategori }}"> {{ $user->kategori }}</option>
                    </select>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <select class="form-select" name="status">
                        ...
                        <option value="non active" @if (isset($user) && $user->status == 'non active') selected @endif>Non Active</option>
                    </select>
                </div>
            </div>
