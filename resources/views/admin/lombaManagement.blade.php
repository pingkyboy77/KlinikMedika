                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-xl-9 col-md-12">
                                <div class="text-sm-end">
                                    <button type="button" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2" data-bs-toggle="modal" data-bs-target=".create-lomba"><i class="mdi mdi-plus me-1"></i> Create Lomba</button>
                                </div>
                            </div>
                        </div>
                    </div>
