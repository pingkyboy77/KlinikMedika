                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mb-2 @error('StaffID') is-invalid @enderror"
                                        id="StaffID" name="StaffID" value="{{ old('StaffID', $staff->StaffID) }}" readonly>
                                    @error('StaffID')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mb-2 @error('telp') is-invalid @enderror"
                                        id="telp" name="telp" value="{{ old('telp', $staff->telp) }}">
                                    @error('telp')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control mb-2 @error('tgl_lahir') is-invalid @enderror"
                                        id="tgl_lahir" name="tgl_lahir" value="{{ old('tgl_lahir', $staff->tgl_lahir) }}">
                                    @error('tgl_lahir')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mb-2 @error('jabatan') is-invalid @enderror"
                                        id="jabatan" name="jabatan" value="{{ old('jabatan', $staff->jabatan) }}" required>
                                    @error('jabatan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($staff->foto)
                                        <div class="mt-3">
                                            <img src="{{ asset('storage/staff/' . $staff->foto) }}" alt="Current Photo"
                                                class="img-thumbnail" style="max-height: 200px;">
                                        </div>
                                    @endif

                                    <div class="mt-2">
                                        <img id="foto-preview" src="#" alt="New Preview" class="img-thumbnail"
                            ...
                            <div class="col-md-6">
                                {{-- Location Fields --}}
                                <div class="form-group">
                                    <label for="id_prov">Province</label>
                                    <select class="form-control mb-2" id="id_prov" name="id_prov">
                                        <option value="">-- Select Province --</option>
                                        @foreach ($provinsi as $item)
                                            <option value="{{ $item->id }}" {{ old('id_prov', $staff->id_prov) == $item->id ? 'selected' : '' }}>
                                                {{ $item->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control mb-2" id="id_kab" name="id_kab">
                                        <option value="{{ $staff->id_kab }}">{{ $staff->kabupaten->name ?? 'Current Selection' }}</option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label for="id_kec">District</label>
                                    <select class="form-control mb-2" id="id_kec" name="id_kec">
                                        <option value="{{ $staff->id_kec }}">{{ $staff->kecamatan->name ?? 'Current Selection' }}</option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label for="id_des">Village</label>
                                    <select class="form-control mb-2" id="id_des" name="id_des">
                                        <option value="{{ $staff->id_des }}">{{ $staff->desa->name ?? 'Current Selection' }}</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mb-2 @error('alamat') is-invalid @enderror" id="alamat" name="alamat"
                                        rows="4">{{ old('alamat', $staff->alamat) }}</textarea>
                                    @error('alamat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control mb-2 @error('tgl_masuk') is-invalid @enderror"
                                        id="tgl_masuk" name="tgl_masuk" value="{{ old('tgl_masuk', $staff->tgl_masuk) }}">
                                    @error('tgl_masuk')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control mb-2 @error('tgl_keluar') is-invalid @enderror"
                                        id="tgl_keluar" name="tgl_keluar" value="{{ old('tgl_keluar', $staff->tgl_keluar) }}">
                                    @error('tgl_keluar')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mb-2" id="status_label"
                                        value="{{ $staff->status == 1 ? 'Active' : 'Inactive' }}" readonly>
                                    <input type="hidden" name="status" id="status2" value="{{ old('status', $staff->status) }}">
                                </div>
                            </div>
                        </div>
